    ...
    <div className='bg-white'>
      ...
      <div className='bg-gradient-to-b from-white to-gray-50'>
        <div className='max-w-7xl mx-auto pt-24 px-4 sm:px-6 lg:px-8'>
          ...
          <div className='mt-12 flex space-y-2 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-4'>
            {tiers.map((tier) => (
              <div
                key={tier.name}
          ...
          <div className='border-t border-gray-700 pt-8 space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-between xl:mt-0'>
            ...
            <form className='sm:flex sm:max-w-md'>
              ...
              <div className='mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0'>
                <button
                  type='submit'
                  className='w-full bg-secondary border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-purple-500'
                >
                  Subscribe
                </button>
              </div>
