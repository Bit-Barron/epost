...
const Login: React.FC<loginProps> = () => {
  ...
  return (
    <>
      ...
      <div className='font-bold flex justify-center'>Du hast kein Konto ? </div>
      <div className='flex justify-center mt-5'>
        <button className='border-gray-200 p-3 border-2 w-96 bg-transparent text-white font-bold rounded-full' onClick={() => router.push("/register")}>
